...
@DataProvider(name="AddJobs")
  public Object[][] DpTest()throws Exception
  {
	...
	return new Object[][] {
		...
		{"Chrome","https://opensource-demo.orangehrmlive.com/","Admin","admin123","software","IT field","Tester"},
		{"Chrome","https://opensource-demo.orangehrmlive.com/","Admin","admin123","software","IT field","Tester"},
		{"Firefox","https://opensource-demo.orangehrmlive.com/","Admin","admin123","software","IT field","Tester"},
