...
public Object[][]DpteST() throws Exception
{
	...
	public void Addskills(String TestURL,String Username,String Password,String jobTitle,String jobDescription,String jobnote) throws Exception
	{
		...
		Addjobtitles_Test2.OpenChromeBrowser();
		Addjobtitles_Test2.OpenOrangeHRM(TestURL);
		Addjobtitles_Test2.Login(Username,Password);
		Addjobtitles_Test2.Addjobtitle(jobTitle,jobDescription,jobnote);
		Addjobtitles_Test2.CloseBrowser();
	}
